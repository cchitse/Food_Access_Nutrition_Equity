...
# Step 2: Clean and Subset the USDA Food Access Research Atlas (Tract Level)

## Step 2.1 - Keep only the 10 required columns `
...
## Step 2.5 – Handle data types and save as query: TX_FoodAccess_Tracts
...
# Step 3: Clean and Subset the County Demographics Dataset

## Step 3.1 – Keep only the 10 required demographic columns ```Select```
...
## Step 3.2 – Replace -1 values with null (missing value handling)
...
## Step 3.3 – Filter to Texas (State = "TX") > 
...
## Step 3.5 – Rename columns using clean names
...
![](11.png)
## Step 3.6 – Correct data types and save as query: TX_County_Demographics
...
# Step 4: Clean and Subset the USDA Food Nutrition Dataset

## Step 4.1 – Keep only the 9 essential nutrient columns ```Select```

**Process:** We keep only 9 necessary columns for the following wrangling process(→ Right-click → Remove Other Columns)

![](13.png)

## Step 4.2 – Remove rows with missing Category

**Process:** Choose Remove Rows > Remove Blank Rows

![](14.png)

## Step 4.3 – Rename columns for consistency
...
## Step 4.5 – Save final nutrition table as query: Food_Nutrition
...
## Step 5.1: Calculate Derived Metrics (USDA Atlas)
...
## Step 5.2 Categorize Nutrition (Food Nutrition) ```Group By```
...
# Step 6: Aggregate Census Tracts to County Level 

**Goal**: Aggregate census tract data up to the county level(```Group By```)

## Step 6.1 - Preparation for Weighted Average
...
## Step 6.3 : Add Custom Columns for key percentages (Pct_LowAccess, Pct_LowIncome_LowAccess, Pct_Urban)
...
![](30.png)
## Step 6.4 : Save as query: TX_FoodAccess_County_Agg
...
# Step 8: Export Final Clean Datasets

## Step 8.1 : Load Food_Nutrition_Final to worksheet and export as Food_Nutrition_Final.csv

![](37.png)

## Step 8.2 : Load Texas_County_Merged to worksheet and export as Texas_County_Merged.csv

![](38.png)

# Step 9: Analysis with Visualizations
...
# Step 10 : Challenge and How We Approached
...
# Step 11 : Description of tool learning 
