...
## USDA Fodd Access Research Atlas
...
### County Demographics -> county_demographics_renamed
...
food_nutrition_renamed = food_nutrition_subset.rename(columns=food_columns_rename)
...
usda_with_metrics = (usda_with_metrics
    .assign(PercentLowAccess = lambda df_: (df_['lapop1'] / df_['Pop2010']) * 100)
)
...
```{python}
usda_with_metrics = (usda_with_metrics
    .assign(PercentLowIncomeLowAccess = lambda df_: (df_['lalowi1'] / df_['TractLOWI']) * 100)
)
